...
export const Login = () => {
  ...
  return (
    <div className="w-full h-screen bg-[#12ad4e]">
      {token && (
      ...
      <div className="w-full flex justify-center items-center">
        <div
          className={`border border-white/10 ${
            token ? "mt-20" : "mt-40"
          } shadow-[#111010] bg-black rounded-lg shadow-md py-10 w-4/5 lg:w-2/5`}
        >
          <div className="h-full w-full flex justify-center">
            <figure className="w-3/4 lg:w-2/4  h-auto ">
              <img src="Logos/Logo2.png" className="w-full h-full" />
            </figure>
          </div>
