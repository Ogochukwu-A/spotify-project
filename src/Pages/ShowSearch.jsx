...
export const ShowSearch = () => {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-black/80 font-semibold flex justify-center pt-10 text-2xl uppercase">
            ...
            {artists.map((artist) => (
              <Fragment key={artist.id}>
                <div className=" h-full w-full ">
                  <div className="bg-black/20 transition duration-500 rounded-xl play-bg py-20 w-4/5 cursor-pointer  ml-[10%]">
                    ...
                    <div className="flex justify-end w-full play  transition duration-500">
                      <div className="bg-[#10b14e] w-1/5 h-10 mr-10 rounded-full">
                    ...
                    <div className="flex justify-start pt-5  w-4/5 ml-[10%]">
                      {artist.name ? (
                        <p className="font-extrabold   text-black/80">
                          {artist.name}
                        </p>
                      ) : (
                        "No Name Found"
