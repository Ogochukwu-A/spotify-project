...
export const Home = () => {
  ...
  return (
    <div className="w-4/5 bg-white/90">
      <div className=" fixed w-4/5">
        <div
          className={` ${
            scroll ? "bg-white/50 backdrop-blur-sm" : ""
          ...
          {token ? (
            ...
            >
              <input
                ...
                className="w-2/4 py-2 relative rounded-full bg-white border border-white/5 outline-none pr-10 text-black/90 text-sm pl-[5%]"
                placeholder="Search for artists, songs and ..."
              />
              <button type="submit" className="text-black absolute mr-[5%]">
